...
GitHub に関連する用語一覧は[こちら](#github-関連用語一覧)を参照してください。
...
インストールの流れは[こちら](/docs/use-kpm/commands/install#インストールの流れ)を参照してください。

### アンインストール

KPM がプラグインをサーバーから削除する一連の流れをアンインストールと呼びます。  
アンインストールの流れは[こちら](/docs/use-kpm/commands/uninstall#アンインストールの流れ)を参照してください。
