...
GitHub 上のプラグインを簡単にインストールする方法は[こちら](/docs/use-kpm/getting-started/install-plugin-with-github)を参照してください。
...
KPM では、 GitHub リポジトリ上に[リリース](#release)されているプラグインをかんたんにインストールできます。
詳しくは[こちら](/docs/use-kpm/use-kpm/getting-started/install-plugin-with-github.mdx)を参照してください。
