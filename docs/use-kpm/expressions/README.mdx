...
将来的に、KPM は TeamKUNPluginManager の別名として使用され、略称ではなくなる可能性があります。\(npmのように)
...
KPM では、 [GitHub](#github) と KPM を連携するために使用します。詳しくは[こちら](/docs/use-kpm/getting-started/link-github.md)を参照してください。
...
### [クエリ\(クエリ文字列)](/docs/use-kpm/expressions/query)
...
<DocCard item={{
    type: "link",
    label: "クエリ文字列とは？",
    docId: "use-kpm/expressions/query",
    href: "/docs/use-kpm/expressions/query",
}} />
