...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: budou("お猫様をお世話するより簡単にプラグインを管理できます。"),
  },
  {
    title: "前提プラグインの自動解決",
  ...
  },
  {
    ...
    description: budou("色分けされたログ、APT/NPM ライクなコマンド、わかりやすいヒント表示。すべてが完璧です！"),
  },
]
  ...
  return (
    <div className={clsx("col col--4")}>
      <div className="text--center">
        <img className={styles.featureSvg} role="img" src={png} alt={title} />
      </div>
